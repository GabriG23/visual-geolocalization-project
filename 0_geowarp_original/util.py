...
def compute_features(geoloc_dataset, model, global_features_dim, num_workers=4,                  # calcola le feature di tutte le immagini
    ...
    query_features = gallery_features[geoloc_dataset.gallery_num:]  # features della query
    gallery_features = gallery_features[:geoloc_dataset.gallery_num]  # features della gallery
